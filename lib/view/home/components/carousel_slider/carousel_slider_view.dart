...
import 'package:my_groceery_mobile/view/home/components/carousel_slider/banner_card.dart';
...
class _CarouselSliderViewState extends State<CarouselSliderView> {
  ...
  @override
  void initState() {
    _bannerList = widget.bannerList.map((e)=>BannerCard(imageUrl: e.images)).toList();
    super.initState();
  }
